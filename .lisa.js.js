...
const productDatabase = {
    "peace-Lily": {
      ...
      price: 29.99,
      originalPrice: 39.99,  
      image: "./Bloom and Petal Haven/pngtree-a-peace-lily-plant-png-image_14144988.png",
...
function addToCart(id, name, price) {
  ...
  if (existingItem) {
    ...
    cart.push({
      ...
      price,
      quantity: 1,
      image: product ? product.image : "./Bloom and Petal Haven/pngtree-a-peace-lily-plant-png-image_14144988.png",
    });
  }
  cartTotal += price;
  updateCartDisplay();
